...
class TopLevelDomainRegExp:
    ...
    am = {'domain_name': r'Domain name:\s+(.+)',
          'status': r'Status:\s(.+)',
          'registrar': r'Registrar:\s+(.+)',
    ...
    im = {'domain_name': r'Domain Name:\s+(.+)',
          'status': None,
          'registrar': None,
          'registrant_country': None,
          'creation_date': '',
    ...
    jp = {'domain_name': r'\[Domain Name\]\s?(.+)',
          'registrar': None,
          'registrant': r'\[Registrant\]\s?(.+)',
          'registrant_country': None,
    ...
    mx = {'domain_name': r'Domain Name:\s?(.+)',
    ...
    theatre = {'extend': 'store'}

    tickets = {'extend': 'store'}
